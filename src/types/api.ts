...
export interface UpdateJobDescriptionRequest extends Partial<Omit<CreateJobDescriptionRequest, 'id'>> {}

export interface JobDescriptionResponse extends ApiResponse<JobDescription> {}
export interface JobDescriptionsResponse extends ApiResponse<JobDescription[]> {}
...
export interface UpdateUserJobRequest extends Partial<Omit<CreateUserJobRequest, 'user_id' | 'job_id'>> {}
...
export interface UpdateEducationRequest extends Partial<Omit<CreateEducationRequest, 'resume_id'>> {}
...
export interface UpdateWorkExperienceRequest extends Partial<Omit<CreateWorkExperienceRequest, 'resume_id'>> {}
