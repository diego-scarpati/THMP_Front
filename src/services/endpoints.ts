...
export const jobApi = {
  ...
  getJobsByCompanyName: (
    companyName: string
  ): Promise<apiTypes.ApiResponse<apiTypes.Job[]>> =>
  ...
  createJob: (
    jobData: apiTypes.CreateJobRequest
  ): Promise<apiTypes.ApiResponse<apiTypes.Job>> =>
  ...
  deleteJob: (
    id: string
  ): Promise<apiTypes.ApiResponse<{ success: boolean }>> =>
    apiService.delete(`/jobs/delete/${id}`),

  bulkCreateJobs: (
    data: apiTypes.BulkCreateJobsRequest
  ): Promise<apiTypes.ApiResponse<string>> =>
...
export const jobDescriptionApi = {
  getAllJobDescriptions: (): Promise<
    apiTypes.ApiResponse<apiTypes.JobDescription[]>
  > => apiService.get("/jobDescriptions/getAll"),

  getJobDescriptionById: (
    id: string
  ): Promise<apiTypes.ApiResponse<apiTypes.JobDescription>> =>
...
export const userApi = {
  createUser: (
    userData: apiTypes.CreateUserRequest
  ): Promise<apiTypes.ApiResponse<apiTypes.User>> =>
...
export const userJobApi = {
  getUserJobs: (
    userId: string
  ): Promise<apiTypes.ApiResponse<apiTypes.UserJob[]>> =>
...
export const keywordApi = {
  ...
  getKeywordById: (
    id: number
  ): Promise<apiTypes.ApiResponse<apiTypes.Keyword>> =>
...
export const skillApi = {
  ...
  ): Promise<apiTypes.ApiResponse<apiTypes.Skill>> =>
...
export const userSkillApi = {
  getUserSkills: (
    userId: string
  ): Promise<apiTypes.ApiResponse<apiTypes.UserSkill[]>> =>
...
export const userExclusionApi = {
  getUserExclusions: (
    userId: string
  ): Promise<apiTypes.ApiResponse<apiTypes.UserExclusion[]>> =>
...
export const userInclusionApi = {
  getUserInclusions: (
    userId: string
  ): Promise<apiTypes.ApiResponse<apiTypes.UserInclusion[]>> =>
...
export const resumeApi = {
  ...
  getResumesByUser: (
    userId: string
  ): Promise<apiTypes.ApiResponse<apiTypes.Resume[]>> =>
...
export const educationApi = {
  getEducationsByResume: (
    resumeId: number
  ): Promise<apiTypes.ApiResponse<apiTypes.Education[]>> =>
...
export const workExperienceApi = {
  getWorkExperiencesByResume: (
    resumeId: number
  ): Promise<apiTypes.ApiResponse<apiTypes.WorkExperience[]>> =>
