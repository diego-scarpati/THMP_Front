...
import type { Job, CreateJobRequest, UpdateJobRequest, BulkCreateJobsRequest, SearchAndCreateJobsRequest, JobQueryParams, JobAcceptanceFilterParams } from '@/types/api'
...
export const useJobsByAcceptance = (formulaAcceptance?: string, gptAcceptance?: string) => {
  return useQuery({
    queryKey: queryKeys.jobs.byAcceptance(formulaAcceptance, gptAcceptance),
    queryFn: () => jobApi.getAllByAcceptance({ 
...
export const useBulkCreateJobs = () => {
  ...
  return useMutation({
    ...
    mutationFn: (jobsData: BulkCreateJobsRequest) => jobApi.bulkCreateJobs(jobsData),
    onSuccess: () => {
      // Invalidate all job lists to refresh data
      queryClient.invalidateQueries({ queryKey: queryKeys.jobs.lists() })
    },
...
export const useSearchAndCreateWithAllKeywords = () => {
  ...
  return useMutation({
    ...
    mutationFn: () => jobApi.searchAndCreateWithAllKeywords(),
    onSuccess: () => {
      // Invalidate all job lists to refresh data
      queryClient.invalidateQueries({ queryKey: queryKeys.jobs.lists() })
    },
